...
# Gravity (Barnes-Hut)
GRAVITY_ACTIVE = "Enable gravitational attraction between particles using Barnes-Hut algorithm"
GRAVITY_STRENGTH = "Gravitational constant multiplier. Higher values = stronger attraction"
GRAVITY_THETA = "Barnes-Hut opening angle (0.5 typical). Lower = more accurate but slower"
GRAVITY_SOFTENING = "Softening parameter to prevent force singularities at close range"
GRAVITY_INITIAL_ROTATION = "Initial rotation around world origin (Z axis). 1.0 = circular orbit velocity, <1 = infalling, >1 = escaping"
